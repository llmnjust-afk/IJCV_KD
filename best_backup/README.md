...
The active ResNet entry now uses G7; this independent backup and the earlier
backups remain available. G7 contains source, scripts and documentation only. Resources,
