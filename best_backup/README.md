...
| [resnet18_cifar100_0911v1](resnet18_cifar100_0911v1/README.md) | Completed CIFAR-100 C100-R1: seven attacks exceed the paper; Clean remains 2.73 pp below. User-selected best ResNet source. |
...
The CIFAR-100 active entries use C100-R1 and C100-M1, each with an independent 0911v1 backup.
