# CIFAR-100 / MobileNet-V2 — 0914v1 C100-M1 已评测冻结备份
...
[0911v1备份](../mobilenetv2_cifar100_0911v1/README.md)保留旧教师版本，不是本目录新教师源码的副本。

2026-09-19：冻结当前M1轻量源码。目录中的0914v1表示实验批次；创建日期为2026-09-19。Python与原已测run逐字一致，脚本路径适配本备份目录。
