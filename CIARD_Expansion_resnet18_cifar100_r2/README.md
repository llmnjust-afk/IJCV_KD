...
2026-09-18：按用户指定，从`run/0914v1/resnet18_cifar100_natorig_awp0p003_cr0p50`保存独立完整轻量源码，与[R1入口](../CIARD_Expansion_resnet18_cifar100/README.md)并列保留。**R2七项主要指标高于R1，但黑盒PGDtrades和AA略低；不作为全面替代。对论文七项攻击全部提高，Clean=63.78%，仍低1.95个百分点。**
...
R1/R2的AWP γ分别为.002/.003，一致性λ均为.50。R2−R1八项依次为+.25/+.33/+.29/+.26/+.10/-.06/+.04/+.22pp；R1的黑盒PGDtrades高.06pp、AA高.11pp，R2其余七项更高。两个入口按用户选择并列保留，不称任一配置全面占优。
