...
`40`, push `0.081740`. No completed 0906v2 evaluation was available at selection.
This is an unvalidated candidate, not an experimentally ranked 0906v2 winner.
It was chosen to increase target-class mixing conservatively while retaining
G3's non-target conditional distribution and its loss weight.
...
remains the 0624 source. MobileNet code and `best_backup/` are unchanged.
