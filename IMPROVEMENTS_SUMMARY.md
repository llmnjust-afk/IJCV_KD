...
- `CIARD_Expansion_mobilenetv2_cifar10_v2/` — MobileNet-V2 学生模型
- `CIARD_Expansion_resnet18_cifar10_v2/` — ResNet-18 学生模型
...
### MobileNet 版本
文件：`CIARD_Expansion_mobilenetv2_cifar10_v2/CIARD.py`
...
### ResNet 版本
文件：`CIARD_Expansion_resnet18_cifar10_v2/CIARD.py`
...
```bash
# MobileNet 版本
cd CIARD_Expansion_mobilenetv2_cifar10_v2
python CIARD.py

# ResNet 版本
cd CIARD_Expansion_resnet18_cifar10_v2
python CIARD.py
```
