...
```bash
sbatch origin_code/0903v1/IJCV_KD/CIARD_Expansion_mobilenetv2_cifar10/train_3090.sbatch
```
...
```bash
sbatch origin_code/0903v1/IJCV_KD/CIARD_Expansion_mobilenetv2_cifar10/eval_3090_best.sbatch
```
